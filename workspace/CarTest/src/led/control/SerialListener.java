...
public class SerialListener implements SerialPortEventListener {
	...
	public SerialListener(BufferedInputStream bis) {
		...
		System.out.println("리스너생성자");
		arduinoConnect.connect("COM10", "arduino");
	...
	public void serialEvent(SerialPortEvent event) {
		...
		case SerialPortEvent.DATA_AVAILABLE: // 데이터가 도착하면...
			...
			try {
				...
				/*
				 * 1. 아두이노와 시리얼통신 할 수 있도록 output스트림 얻기 => 생성자에서 한 번 작업할 수 있도록 처리
				 * 2. output스트림으로 '0','1'보내기 => can으로 수신된 데이터를 비교해서 :
